...
export default class LeafletMap extends Component<{}, State> {
  ...
  zoomToFeature = (component, e) => {
    ...
    this.setState({zoom: 7, lat:stateLat, lng:stateLng, stateName: stateName, stateDensity: stateDensity});
    }


  resetMap(){
    this.setState(state => ({ lat: 37.090240, lng: -95.712891, zoom: 5, stateName: " ", stateDensity: " "}));
  }
