...
export default class LeafletMap extends Component<{}, State> {
  ...
  clickSelectState = (component, e) => {
    ...
    this.setState({originalState: "False", zoom: 7, lat:stateLat, lng:stateLng, stateName: stateName, stateDensity: stateDensity, statePopulation: statePopulation, stateNumDistricts:stateNumDistricts});
    }
  ...
  dropdownStateSelect(ev, stateNum){
    ...
    // this.clickSelectState.bind(null, e)
    this.setState({originalState: "False", zoom: 7, lat:stateLat, lng:stateLng, stateName: stateName, stateDensity: stateDensity, statePopulation: statePopulation, stateNumDistricts:stateNumDistricts});
  }
